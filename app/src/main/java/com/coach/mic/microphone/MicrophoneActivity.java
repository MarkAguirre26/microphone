...
public class MicrophoneActivity extends AppCompatActivity implements OnSharedPreferenceChangeListener, OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(APP_TAG, "Opening red activity");
    	...
    	b.setImageBitmap(BitmapFactory.decodeResource(getResources(), mActive ? R.drawable.mic : R.drawable.red));
    ...
    public void onDestroy() {
    	...
    	Log.d(APP_TAG, "Closing red activity");
